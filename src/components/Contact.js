...
<div className="content">
  ...
  <div className="contact-info" data-aos="fade-right">
    <ul className="circle-cont">
      <li><a className="circle2"><i class="fas fa-phone-square-alt"></i>+91 7410153599</a></li>
      <li className="mx-auto flex sm:flex-nowrap"><a href="mailto:rajeshbagul2001@gmail.com"className="circle"><i class="fas fa-envelope-square"></i></a>rajeshbagul2001@gmail.com</li>
      <li><a href="https://github.com/Rajesh270712" target="_blank" className="circle"><i class="fab fa-github"></i>Github</a></li>
      <li><a href="https://www.linkedin.com/in/rajesh-bagul/" target="_blank" className="circle"><i class="fab fa-linkedin"></i>LinkedIn</a></li>
